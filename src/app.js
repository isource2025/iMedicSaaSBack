...
const epicrisisRoutes = require('./routes/epicrisis.routes');
...
const catalogoSqlRoutes = require('./routes/catalogoSql.routes');
...
const balanceHidricoRoutes = require('./routes/balanceHidrico.routes');
...
const interconsultasRoutes = require('./routes/interconsultas.routes');
...
const admissionNuevaRoutes = require('./routes/admissionNueva.routes');
const visitaAcompanantesRoutes = require('./routes/visitaAcompanantes.routes');
const rendicionesRoutes = require('./routes/rendiciones.routes');
const liquidacionImportRoutes = require('./routes/liquidacionImport.routes');
...
app.use('/api/catalogos-sql', catalogoSqlRoutes);
...
app.use('/api/balance-hidrico', balanceHidricoRoutes);
...
app.use('/api/admision-nueva', admissionNuevaRoutes);
app.use('/api/visita-acompanantes', visitaAcompanantesRoutes);
app.use('/api/rendiciones', rendicionesRoutes);
app.use('/api/liquidaciones', liquidacionImportRoutes);
