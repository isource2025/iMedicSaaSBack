...
function mapPedidoToInterconsulta(p) {
	...
	return {
		...
		PacienteTipoDocumento: p.PacienteTipoDocumento || null,
		PacienteSexo: p.PacienteSexo || null,
		PacienteSexoDescripcion: p.PacienteSexoDescripcion || null,
		ObraSocial: p.ObraSocial || null,
		PacienteAfiliado: p.PacienteAfiliado || null,
		PacienteNumeroHC: p.PacienteNumeroHC || null,
		PacienteDomicilio: p.PacienteDomicilio || null,
		PacienteLocalidad: p.PacienteLocalidad || null,
		PacienteTelefono: p.PacienteTelefono || null,
		PacienteTelefonoAlternativo: p.PacienteTelefonoAlternativo || null,
		PacienteEmail: p.PacienteEmail || null,
		PacienteFechaNacimiento: p.PacienteFechaNacimiento || null,
		PacienteEdad: p.PacienteEdad ?? null,
