...
CREATE TABLE IF NOT EXISTS `imPersonal` (
  ...
  `ApellidoNombre` VARCHAR(120) NULL,
  `TipoDocumento` VARCHAR(20) NULL,
  `MatriculaNacional` INT NULL,
  `ValorEspecialidad` INT NULL,
  `ValorServicio` VARCHAR(30) NULL,
  `ValorServicioParaFacturar` VARCHAR(30) NULL,
  `ValorCategoria` INT NULL,
